...
public class RedBlackTree<T> {
    ...
    public RedBlackTree ( RedBlackNode aTreeNode){
        header = aTreeNode;
    }
    ...
    public static RedBlackTree getLeft() {
        return new RedBlackTree(header.left);
    }

    public static RedBlackTree getRight() {
        return  new RedBlackTree(header.right);
    }
    ...
    public int height (RedBlackTree<T> binarySearchTree){
        if (binarySearchTree.isEmpty2()) return -1;
        else if(binarySearchTree.getLeft().isEmpty2() && binarySearchTree.getRight().isEmpty2()) return 1 ;
        else if(binarySearchTree.getRight().isEmpty2()) return 1 + height(binarySearchTree.getLeft());
        else if(binarySearchTree.getLeft().isEmpty2()) return 1 + height(binarySearchTree.getRight());
        else {
